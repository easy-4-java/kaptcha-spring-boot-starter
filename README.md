...
| JDK | `17` |
| Coordinates | `io.github.easy4j:kaptcha-spring-boot-starter:1.0.0.RELEASE` |
...
| `CaptchaResolver` bean | ✅ Stable | Auto-registered via KaptchaAutoConfiguration |
...
|---|---|---|
| `CaptchaResolver` | classpath + property | not created |

...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/kaptcha-spring-boot-starter)](https://github.com/easy-4-java/kaptcha-spring-boot-starter)
...
> **Artifact ID**：`kaptcha-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**kaptcha-spring-boot-starter** is a Spring Boot starter that integrates **kaptcha** for applications using kaptcha. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume kaptcha capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using kaptcha |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for kaptcha |
| JDK | `17` |
| Coordinates | `io.github.easy4j:kaptcha-spring-boot-starter:3.2.x.20260527-SNAPSHOT` |
| Config Prefix | `kaptcha` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers kaptcha beans automatically |
| Property Binding | ✅ Stable | Binds `kaptcha.*` to `KaptchaProperties` |
| `KaptchaResolver` bean | ✅ Stable | Auto-registered via KaptchaAutoConfiguration |
...
|---|---|---|
| `KaptchaResolver` | classpath + property | not created |
...
```java
@Autowired
private KaptchaResolver kaptchaResolver;
```
...
|---|---|---|:---:|---|:---:|
| `kaptcha.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl kaptcha-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `kaptcha.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/kaptcha-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/kaptcha-spring-boot-starter)
